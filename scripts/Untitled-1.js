...
"#player?artist=${artist}&songid=${song.songid}&songname=${song.songname}&albummid=${song.albummid}&duration=${song.interval}"
https://twhy.github.io/qq-music/#player?artist=李荣浩&songid=5016168&songname=李白&albummid=004AhJHV3slLjN&duration=273
<a class="song-item" href="#player?artist=李荣浩&amp;songid=5016168&amp;songname=李白&amp;albummid=004AhJHV3slLjN&amp;duration=273">
          <i class="icon icon-music"></i>
          <div class="song-name ellipsis">李白</div>
          <div class="song-artist ellipsis">李荣浩</div>
        </a>